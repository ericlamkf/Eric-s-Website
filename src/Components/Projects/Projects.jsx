        ...
        <div className='projects'>
            <div className="project-container">
                <div className="project">
                    <motion.video viewport={{margin:"-200px"}} initial={{opacity: 0, scale:0.8}} whileInView={{opacity:1, scale:1}} transition={{type:"spring", stiffness:300, duration:0.6}} onMouseEnter={playVideo} onMouseLeave={stopVideo} src={project1} loop playsInline autoPlay className='video'></motion.video>
